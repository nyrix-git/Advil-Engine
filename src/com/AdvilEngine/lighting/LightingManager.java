...
public class LightingManager {
	...
	// Note: this may cost huge amounts of fps depending on how many lights there
	// are since were drawing more circles for the gradient effect
