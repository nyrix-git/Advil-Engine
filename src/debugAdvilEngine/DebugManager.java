...
public class DebugManager {
	...
	public static void countTick() { // default tps is 60 so 60 tps
		// ToDo: in the future, change it so the user can set their ticks per second
		int TickCounterStartValue = 0;
		TickCounterStartValue++;
		if (TickCounterStartValue >= 60) {
			TickCounterStartValue = 0;
			System.out.println(TickCounterStartValue);
		}
	}
	
	// get methods
	public static int getTPS() {
		AdvilEngine advilengine = new AdvilEngine();
